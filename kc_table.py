...
_KC_VALUES = [
    [0.0, 0.004, 0.007, 0.009, 0.012, 0.015, 0.017, 0.020, 0.021, 0.022, 0.023],  # alpha_R = 0.01
    [0.0, 0.020, 0.035, 0.045, 0.060, 0.075, 0.085, 0.100, 0.110, 0.115, 0.120],  # alpha_R = 0.10
    [0.0, 0.040, 0.070, 0.090, 0.120, 0.150, 0.170, 0.200, 0.210, 0.220, 0.230],  # alpha_R = 0.20
    [0.0, 0.060, 0.100, 0.130, 0.170, 0.210, 0.230, 0.270, 0.290, 0.300, 0.310],  # alpha_R = 0.30
    [0.0, 0.080, 0.130, 0.170, 0.220, 0.270, 0.300, 0.350, 0.380, 0.400, 0.410],  # alpha_R = 0.40
    [0.0, 0.100, 0.170, 0.210, 0.280, 0.340, 0.380, 0.430, 0.470, 0.490, 0.510],  # alpha_R = 0.50
    [0.0, 0.120, 0.200, 0.250, 0.330, 0.400, 0.450, 0.520, 0.560, 0.580, 0.600],  # alpha_R = 0.60
]
...
def kc_from_psi_alpha_r(psi: float, alpha_r: float) -> float:
    ...
    * psi < 0 → ValueError; psi > 3.5 прижимается к 3.5.
    ...
    * Внутри диапазона используется билинейная интерполяция таблицы.
    ...
    psi_clamped = 3.5 if psi > 3.5 else psi
